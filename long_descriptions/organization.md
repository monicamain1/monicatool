The "organization" parameter refers to the implementation of the internal parts of an on-chip monitoring system, with reference to the MONICA model. 

The MONICA model abstracts a monitoring process with three parts: a Monitored Behaviour, a Monitoring Infrastructure, and a Monitoring Processor. They are detailed in the following:
